...
/*
   ...
   - ساخت Poll توسط Admin
   - رأی دادن به Poll
   - API Notifications
   - Support + اعلان پاسخ مدیریت
   - Rubika
   - Messenger
...
if (
    ...
    /*
     * نظرسنجی منتشرشده → اعلان برای همه
     */
...
if (
    ...
    /*
     * اگر قبلاً رأی داده، رأی قبلی
     * را به گزینه جدید منتقل می‌کنیم.
     */
...
if (
    ...
    /*
     * پاسخ مدیریت → اعلان برای همان کاربر
     */
...
if (
    path === "/api/messenger/users/search" &&
    method === "GET"
) {
